...
fn paire_de_fous_donne_bonus_aux_blancs() {
    let board_un_fou = board_from_fen("7k/8/8/8/8/8/8/K2B4 w - - 0 1").unwrap();

    let board_deux_fous = board_from_fen("7k/8/8/8/8/8/8/K2BB3 w - - 0 1").unwrap();
...
fn roque_blanc_donne_bonus() {
    let board_non_roque = board_from_fen("7k/8/8/8/8/8/8/R3K2R w KQ - 0 1").unwrap();

    let board_roque = board_from_fen("7k/8/8/8/8/8/8/R4RK1 w - - 0 1").unwrap();
